var Photo = React.createClass({displayName: 'Photo',
	...
	render: function() {
		console.log("render at data " + this.props.date_begin);
		console.log("render at url " + this.props.url);
...
var PhotoGrid = React.createClass({displayName: 'PhotoGrid',
	render: function() {
		...
		this.props.photos.forEach(function(photoModel) {
			rows.push(React.createElement(Photo, {photo: photoModel.photo, key: photoModel.photo}));
		});
		return (
...
var collectionPhotos = [{photo: 'http://www.flickr.com/photos/redisdead/11859561736/', name: 'Football'},
	{photo: 'http://farm3.staticflickr.com/2877/11878050486_ffc84342f6_b.jpg',  name: 'Baseball'},
	{photo: 'http://farm6.staticflickr.com/5544/11885543615_4b41886ea8_b.jpg', name: 'Basketball'},
	{photo: 'http://farm4.staticflickr.com/3674/11914541585_dd01bf39e1_b.jpg', name: 'iPod Touch'}
];
