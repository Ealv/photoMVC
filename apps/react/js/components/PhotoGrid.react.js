            ...
            for (var key in allPhotos)
               photos.push( < PhotoItem key = {
                  ...
                  return ( < section id = "main" >
                        ...
                        type = "checkbox"
                        onChange = {
                           this._onToggleCheckAll
                        }
                        checked = {
                           this.props.areAllChecked ? 'checked' : ''
                        }
                        /> < label htmlFor = "toggle-all" > Mark all as checked < /label > < ul className = "grid-photo" >
                        < div className = "row" > {
                           photos
                        } < /div> < /ul > < /section>);
                     },
